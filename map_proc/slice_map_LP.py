...
ZELDA_DIR = os.path.join(BASE_DIR, "..", "processed_LP")   # 원본 맵 폴더
...
# 3. 단일 이미지 처리
# =========================
TARGET_FILE = "LegendOfZelda-ALinkToThePast-DarkPalace-1F_room22106.png"  # 👉 여기 파일 이름만 바꿔주면 됨
img_path = os.path.join(ZELDA_DIR, TARGET_FILE)

count = slice_map(img_path, rows=1, cols=3)  # 👉 원하는 방 개수로 설정
